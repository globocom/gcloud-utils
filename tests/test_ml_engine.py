...
class TestMlEngine(unittest.TestCase):
    ...
    def test_create_new_model(self):
        ...
        self.assertDictEqual(ast.literal_eval(post_to_create_model.body), expected)
    ...
    def test_create_new_model_version_4_5(self):
        ...
        self.assertEqual(
            ...
            json.loads('{"deploymentUri": "gs://BUCKET_NAME/jobs/JOB_ID/export", "name": "v4_5"}')
        )
    ...
    def test_create_new_model_version_5_0(self):
        ...
        self.assertEqual(
            json.loads(post_to_create_model.body),
            json.loads('{"deploymentUri": "gs://BUCKET_NAME/jobs/JOB_ID/export", "name": "v5_0"}')
        )
    ...
    def test_create_new_model_version_empty(self):
        ...
        self.assertEqual(
            json.loads(post_to_create_model.body),
            json.loads('{"deploymentUri": "gs://BUCKET_NAME/jobs/JOB_ID/export", "name": "v0_1"}')
        )
